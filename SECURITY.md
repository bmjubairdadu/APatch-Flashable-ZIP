...
[APatch](https://github.com/LyraVoid/APatch) manager as
...
- The installer always keeps a stock `boot` backup
  (`APatch-Backup/stock-boot_?.img`) — keep a copy off-device.

## Reporting a vulnerability

**Do not open a public issue for security problems.** Instead, open a
[private security advisory](https://github.com/bmjubairdadu/APatch-Flashable-ZIP/security/advisories/new)
...
- Upstream vulnerabilities in APatch/KernelPatch themselves should
  also be reported to [LyraVoid/APatch](https://github.com/LyraVoid/APatch/security)
